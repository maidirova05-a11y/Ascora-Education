      ...
      >
        {SLIDES.map((slide) => (
          <SwiperSlide key={slide.id}>
            ...
            {/* Card content + nav — all slide together */}
            <div className="hero-slide-inner">
              ...
              <div className="hero-slide-nav">
                ...
                <div className="hsn-dots">
                  {SLIDES.map((_, idx) => (
                    <button key={idx} className={`hsn-dot ${idx === activeIdx ? 'hsn-dot--active' : ''}`}
                      onClick={() => swiperRef.current?.slideToLoop(idx)} aria-label={`Слайд ${idx + 1}`} />
                  ))}
                </div>
