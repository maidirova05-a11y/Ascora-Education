...
const ROUTES = [
  ...
  },
  {
    ...
    description: 'Летние языковые и спортивные лагеря за границей для детей 7–18 лет из Казахстана: Турция, Болгария, Испания, Англия, Малайзия и другие страны. Полное сопровождение и трансфер.',
    jsonLd: [],
  },
  {
